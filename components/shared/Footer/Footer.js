  ...
  return (
    <div>
      <div className="container items-center">
        <footer className="text-gray-700 transition duration-500 ease-in-out transform bg-white rounded-lg ">
          <div className="flex flex-col flex-wrap justify-center p-5 md:flex-row">
            <nav className="flex flex-wrap items-center justify-center w-full mx-auto mb-6 text-base nprd">
              <a
                href="#"
                className="px-4 py-1 mr-1 text-base text-gray-500 transition duration-500 ease-in-out transform rounded-md focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:text-black "
              >
                Pricing
              </a>
              <a
            ...
            <span className="inline-flex justify-center w-full mx-auto mt-2 mr-2 sm:ml-auto sm:mt-0">
              ...
              <a className="ml-3 text-gray-700 hover:text-black">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
